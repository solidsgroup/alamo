...
# build job that compiles BOTH the A100 (sm_80) and H200 (sm_90) 3D binaries.
...
# ---- Config (override via env, e.g. ALAMO_DIR=/some/path sh build_alamo_nova_3d.sh) ----
...
echo "=== build complete ==="
ls -lh bin/alamo_gpu-3d*cuda* || true
END_OF_SBATCH
