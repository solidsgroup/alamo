...
- Branch DoD items 1–5 are all **DONE** (see `benchmark/archive/PHASE5_BRANCH_DONE.md`).
- Phase-field GPU speedup is **proven**: single A100 vs 64-rank CPU node ≈ 9.6× at
  128³ and 13.1× at 256³ (`benchmark/archive/PHASE3_R3_crossover.md`).
...
- 5 pre-existing CPU-suite failures in Flame lineage (thermal.on=0 null write,
  ...
  documented in `benchmark/archive/PHASE4_R4_dispatch.md`.
...
- Forward plan: `benchmark/archive/GPU_ROADMAP_V2.md`
- Branch policy: `benchmark/GPU_BRANCH_GUIDE.md`
- Phase 0–5 DoD (complete): `benchmark/archive/PHASE5_BRANCH_DONE.md`
- Phase-3 crossover results: `benchmark/archive/PHASE3_R3_crossover.md`
- Elastic fix root-cause: `GPU_BRANCH_GUIDE.md` D1 section
- Elixir-race audit (A4): `benchmark/archive/elixir_race_audit.md`
- Static kernel resource dump: `benchmark/archive/G0_BASELINE_OF_RECORD.md`
