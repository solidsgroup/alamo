...
Operator::Elastic::Degradation::Cubic::Cubic (amrex::Real _C11, amrex::Real _C12, amrex::Real _C44,
...
amrex::Real
Operator::Elastic::Degradation::Cubic::C(const int p, const int q, const int s, const int t) const
{
