...
{
template<class T>
Elastic2<T>::Elastic2 (const Vector<Geometry>& a_geom,
		     const Vector<BoxArray>& a_grids,
		     const Vector<DistributionMapping>& a_dmap,
		     const LPInfo& a_info)
{
	BL_PROFILE("Operator::Elastic2::Elastic2()");
...
template<class T>
void
Elastic2<T>::define (const Vector<Geometry>& a_geom,
		    const Vector<BoxArray>& a_grids,
		    const Vector<DistributionMapping>& a_dmap,
		    const LPInfo& a_info,
		    const Vector<FabFactory<FArrayBox> const*>& a_factory)
{
	BL_PROFILE("Operator::Elastic2::define()");
...
{
	BL_PROFILE("Operator::Elastic2::SetModel()");
...
template<class T>
void
Elastic2<T>::Fapply (int amrlev, int mglev, MultiFab& a_f, const MultiFab& a_u) const
{
	BL_PROFILE("Operator::Elastic2::Fapply()");
...
template<class T>
void
Elastic2<T>::Diagonal (int amrlev, int mglev, MultiFab& a_diag)
{
	BL_PROFILE("Operator::Elastic2::Diagonal()");
...
template<class T>
void
Elastic2<T>::Error0x (int amrlev, int mglev, MultiFab& R0x, const MultiFab& x) const
{
	BL_PROFILE("Operator::Elastic2::Error0x()");
	Util::Message(INFO);
...
template<class T>
void
Elastic2<T>::Strain  (int amrlev,
		    amrex::MultiFab& a_eps,
		    const amrex::MultiFab& a_u,
		    bool voigt) const
{
	BL_PROFILE("Operator::Elastic2::Strain()");
...
template<class T>
void
Elastic2<T>::Stress (int amrlev,
		    amrex::MultiFab& a_sigma,
		    const amrex::MultiFab& a_u,
		    bool voigt) const
{
	BL_PROFILE("Operator::Elastic2::Stress()");
...
template<class T>
void
Elastic2<T>::Energy (int amrlev,
		    amrex::MultiFab& a_energy,
		    const amrex::MultiFab& a_u) const
{
	BL_PROFILE("Operator::Elastic2::Energy()");
...
template<class T>
void
Elastic2<T>::averageDownCoeffs ()
{
	BL_PROFILE("Elastic2::averageDownCoeffs()");
...
template<class T>
void
Elastic2<T>::averageDownCoeffsToCoarseAmrLevel (int /*flev*/) 
{
	/*
	BL_PROFILE("Operator::Elastic2::averageDownCoeffsToCoarseAmrLevel()");
...
template<class T>
void
Elastic2<T>::averageDownCoeffsSameAmrLevel (int amrlev)
{
	BL_PROFILE("Elastic2::averageDownCoeffsSameAmrLevel()");
...
template<class T>
void
Elastic2<T>::FillBoundaryCoeff (MultiTab& sigma, const Geometry& geom)
{
	BL_PROFILE("Elastic2::FillBoundaryCoeff()");
	for (int i = 0; i < 2; i++)
	{
		MultiTab & mf = sigma;
