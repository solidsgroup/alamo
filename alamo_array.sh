...
AP_arr=(D_vf_7/D_00_AP.xyzr E_vf_7/E_00_AP.xyzr F_vf_6/F_00_AP.xyzr G_vf_14/G_00_AP.xyzr)
eta_arr=(D_vf_7/D_00_void.xyzr E_vf_7/E_00_void.xyzr F_vf_6/F_00_void.xyzr G_vf_6/G_00_void.xyzr)
plot_file_arr=(D_vf_7_0_void_1 E_vf_7_0_void_1 F_vf_6_0_void_1 G_vf_14_0_void_1)
...
plot_file=${plot_file_arr[$SLURM_ARRAY_TASK_ID]}
...
echo "======================================================"
echo " Simulation with plot file=${plot_file} completed"
echo " End time: $(date)"
echo "======================================================"
