...
Status: draft
Class: correctness
Recognizer: regex: `\.setVal\(0\.0\)|\.mult\(|\.plus\(`
...
Constraints: Keep scope narrow. Mandatory when recognizer matches in a device-backed path. Keep operation ordering, component ranges, and synchronization unchanged.
